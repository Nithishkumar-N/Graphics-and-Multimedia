...
# Notes (macOS):
#   - Run from Terminal the first time to grant mic/camera permissions.
#   - If no prompt appears, enable Terminal under System Settings → Privacy & Security → Microphone & Camera.
